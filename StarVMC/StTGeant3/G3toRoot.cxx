...
//
    char namec[30];
    strcpy(namec,((StTGeant3*)gMC)->VolName(1));
...
// Number of children
	    ...
	    strcpy(namec,((StTGeant3*)gMC)->VolName(ivol));
	    if (nch >= 0) {
		printf("\n %s has %d children  \n ", namec,  nch);
	    } else {
		printf("\n %s has  divisions \n ", namec);
...
// Name
		strcpy(namec,((StTGeant3*)gMC)->VolName(-icvol));
		tmp = new char[4];
...
// Get material parameters
	    ((StTGeant3*)(gMC))->Gfmate (imat,namate,a,z,dens,radl,absl,par,npar);
