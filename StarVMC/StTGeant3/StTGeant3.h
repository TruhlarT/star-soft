#ifndef ROOT_StTGeant3
#define ROOT_StTGeant3 
/* Copyright(c) 1998-1999, ALICE Experiment at CERN, All rights reserved. *
 * See cxx source for full Copyright notice                               */

/* $Id: StTGeant3.h,v 1.1 2004/07/17 20:02:55 perev Exp $ */
...
/////////////////////////////////////////////////////////////////////////////////////////////
  ...
  virtual Erwork_t* Erwork() const {return fErwork;}
     ...
     //Bridge routines (G3Bridge interface
static void Brxgtrak(Int_t &mtrack, Int_t &ipart, Float_t *pmom, 
		     Float_t &e, Float_t *vpos, Float_t *polar,Float_t &tof);
static void Brxouth();
static void Brxinh ();
static void Bginvol(Float_t *x, Int_t &isame);
static void Bgtmedi(Float_t *x, Int_t &numed);
static void Bgmedia(Float_t *x, Int_t &numed, Int_t &check);
static void Bgtmany(Int_t &level1);
static void Bgtonly(Int_t &isOnly);
static void Bglvolu(Int_t &nlev, Int_t *lnam,Int_t *lnum, Int_t &ier);
static void Bgtnext();
static void Bggperp(Float_t *x, Float_t *norm, Int_t &ierr);
static void Bgrndmq(Int_t &is1, Int_t &is2, const Int_t &,const char*, int );
static void Bgrndm (Float_t *r, const Int_t &n);
...
private:
  ...
  StTGeant3(const StTGeant3 &) : TVirtualMC() {}
  StTGeant3 & operator=(const StTGeant3&) {return *this;}
