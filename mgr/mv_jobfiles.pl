...
#  $Id:
#
#  $Log:   mv_jobfiles.pl - script for Web presentaion of node and Jobstatus
...
my $dir_arch = "/star/u2e/starreco/P00he/requests/daq/archive";
my $dir_job = "/star/u2e/starreco/P00he/requests/daq/jobfiles";
