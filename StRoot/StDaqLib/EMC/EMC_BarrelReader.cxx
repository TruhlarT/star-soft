 ...
 ***************************************************************************
 * $Log: Navigates through pointers and Fills Barrel Structs
 *
 **************************************************************************/
...
// fout<<"index "<<index<<"m "<<m<<"e "<<e<<"s "<<s<<"ADC  "<<pADCR->fiberData[index]<<endl;
   }
   mTheTowerAdcR.TowerADCArray[index]=pADCR->fiberData[index];
   }//stat_index
  }
...
//fout<<"index "<<daq_tower<<"index_jose "<<index_jose<<"Crate "<<Crate+15<<"tdc "<<tdc<<endl;
}
else
{
return 0;
