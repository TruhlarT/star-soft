/***************************************************************************
 *
 * $Id: StFcsHit.cxx,v 1.1.2.1 2018/08/24 15:14:36 jwebb Exp $
 *
...
unsigned short StFcsHit::detectorId() const {return mDetectorId;}
...
void StFcsHit::setDetectorId(unsigned short val) { mDetectorId = val; }
...
ostream& operator<<(ostream& os, const StFcsHit& v)
{
  return os << Form("StFcsHit: det=%2d id=%3d crt=%1d slot=%2d ch=%2d timebin=%3d adc=%4d E=%6.2f",
		    v.detectorId(),v.id(),v.crate(),v.slot(),v.channel(),
