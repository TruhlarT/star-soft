...
*
* Bellwied Rene April 23, 2008 in svt-hn@www.star.bnl.gov
*Hi,
*So I have talked some more to Bob and we have realized that the epoxy also
*was used to fill in the bow of the ladder support relative to the wafers,
*therefore epoxy thicknesses between 500 micron and up to 1 mm are
*possible. Based on this information and the actual layout I am
*suggesting the following changes:
*
*1.) change the material definition for the sub-volume(s) SRHC_1 from
*SVTT_ROHA to SVTT_GLASS. done
*
*2.) increase the thickness of all three wafer ladder SHRC_1 sub-volumes /* yf SHRC => SGLA or  SAGP ? done for SGLA */
*(one dimension per super-layer)  from 0.0075 to 0.075 (from 75 micron
*to 750 micron).
*
*3.) increase the thickness of all three electronics ladder SGLA_1 sub-volumes /* yf SGLA =>SRHC ? done for SRHC */
*(one per super-layer) from 0.01905 to 0.1 (from 190.5 micron to 1 mm).
*
*This will lead to a weight increase of 93.22 g for the seven wafer ladder
*and then
*propagate accordingly to the fewer wafer ladders. It will also lead to a
*radiation
*length increase per SVT layer of about 0.4-0.6%. This could be an
*over-estimate
*but because we don't know the exact make-up of the epoxy (in terms of glass
*and aluminum admixtures) we should try it with those numbers and see whether
*the 'SVT tomography' plots can be reproduced in GEANT with this new geometry.
*
*I am out of town until Monday, but please send e-mail if there are questions.
*
*Thanks, Rene
*========================================
* Bellwied Rene May 2, 2008 
*Hi Yuri,
*so I have checked again and you're right that I just
*mixed up the thicknesses.
*
*So for the wafer ladder volume:
*alter SRHC_1 in all three superlayers by
*a.) change SVTT_ROHA to SVTT_GLASS
*b.) change dz from 0.01905 to 0.075
*
*And for the electronics ladder volume:
*alter SGLA_1 in all three superlayer by
*a.) change dz from 0.0075 to 0.1
*
*If you do these changes in all three superlayers
*(SLYD_1:2,SLYD_3:4,SLYD_5:6) I calculate a
*weight increase of around 90 g for the outer layer
*and accordingly less for the other layers.
*
*Cheers, Rene
...
*
*******************************************************************************
Module  SVTTGEO11 is evolution of svttgeo6 with carbon replacing Be as per Dave Lynn: 
...
*
   Fill SWCA ! Wafer Carrier
      ...
      RoHaThk   = 0.0750     ! 05/02/08    | 0.2        ! yf 05/01.08 0.0381     ! Roha cell plus glue thickness 
...
*
   Fill SELC ! electronics carrier data
      ...
      GlassThk = 0.2000      ! 05/02/08  ! 0.1500      ! yf 05/01/08 0.0150      ! thickness of glass insulator
