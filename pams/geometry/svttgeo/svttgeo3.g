* $Id: svttgeo3.g,v 1.7 2008/11/19 04:08:32 perev Exp $
*
* $Log: svttgeo3.g,v $
* Revision 1.7  2008/11/19 04:08:32  perev
...
* removed from here and is now residing in its
* own source directory and files. As a result,
* its configuration is no longer controlled
* via the "number of layers", as was the case
* before, and is a lot more flexible.
*
* Smaller changes:
*
* replaced the material in the shield support cage
* rods from air (unimportant for prior data as
* this is new element anyway) to carbon
*
* Changed the radius of the outer shield so that
* the SSD fits in. This is subject to further
* revision.
*
...
*
*******************************************************************************
Module  SVTTGEO3  is the SVT geometry for STAR: corrected and without SSD
   Author  Maxim Potekhin
*   based on the SVTTGEO2 code
   created 18 Nov 03
*                                                                             *
*------------------------------------------------------------------------------
*  Division lines:                                                            *
